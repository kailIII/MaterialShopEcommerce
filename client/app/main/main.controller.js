...
constructor($scope, $state, $stateParams, $location, Cart, Product, Brand, Category, Feature, Settings, socket, $rootScope, $injector, $loading, $timeout,$mdMedia) {
    var vm = this
    ...
    this.scroll = function() {
        if (this.products.busy || this.products.end){ return;}
        this.products.busy = false;
